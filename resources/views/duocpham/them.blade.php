            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                <h4 class="title">Thêm dược phẩm</h4>
                            </div>
                            <div class="content">
                                <form action="{{route('postthemdp')}}" method="POST" enctype="multipart/form-data">
                                    <input type="hidden" name="_token" value="{{csrf_token()}}"/>
                                        <div class="row">
                                            <div class="col-md-5">
                                            <div class="form-group">
                                                    <label>Tên dược phẩm</label>
                                                <input type="text" class="form-control" name="tenDuocPham">
                                            </div>
                                            <div class="form-group">
                                                    <label>Đơn giá</label>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="nuocSanXuat">
                                            </div>
                                        </div>
                                    </div>
